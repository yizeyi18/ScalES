...
int main(int argc, char ** argv) 
{
  ...
  SpBlckPtn sbptn;
  {
    ...
    ownerinfo[SpBlckKey(1,0)] = 0;
    ownerinfo[SpBlckKey(1,1)] = 1;
    ownerinfo[SpBlckKey(1,2)] = 1;
    ownerinfo[SpBlckKey(2,1)] = 2;
    ownerinfo[SpBlckKey(2,2)] = 2;
    ownerinfo[SpBlckKey(2,3)] = 2;
    ownerinfo[SpBlckKey(3,2)] = 3;
    ownerinfo[SpBlckKey(3,3)] = 3;
  }
