...
/* double precision */
   ...
   void (*dpotrf) (char *uplo, BlopexInt *n,
                  double *a, BlopexInt * lda, BlopexInt *info);
   void (*dsygv) (BlopexInt *itype, char *jobz, char *uplo, BlopexInt * n,
...
/* komplex (double precision complex)*/
   ...
   void (*zpotrf) (char *uplo, BlopexInt *n,
                  komplex *a, BlopexInt *lda, BlopexInt *info);
   void (*zhegv) (BlopexInt *itype, char *jobz, char *uplo, BlopexInt * n,
...
// LLIN: The condition number routines are for debugging purpose.
void zpocon_(char *uplo, BlopexInt *n, komplex *a, BlopexInt *lda, double *anorm, double *rcond, komplex *work, double *rwork, BlopexInt *info);

void dpocon_(char *uplo, BlopexInt *n, double *a, BlopexInt *lda, double *anorm, double *rcond, double *work, BlopexInt *iwork, BlopexInt *info);
